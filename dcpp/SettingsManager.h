...
public:
	...
	enum BoolSetting { BOOL_FIRST = INT_LAST + 1,
		...
		AUTO_SEARCH_AUTO_MATCH, NO_SAME_USER_SOURCE, AUTODROP_ALL, AUTODROP_DISCONNECT, AUTODROP_FILELISTS,
		...
		HUB_USER_COMMANDS, IGNORE_BOT_PMS, IGNORE_HUB_PMS, SKIP_TRAY_BOT_PMS, JOIN_OPEN_NEW_WINDOW, KEEP_FINISHED_FILES,
		KEEP_LISTS, ALLOW_NAT_TRAVERSAL, LIST_DUPES, LOG_DOWNLOADS, LOG_FILELIST_TRANSFERS, LOG_FINISHED_DOWNLOADS,
